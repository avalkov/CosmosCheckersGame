...
export class QueryClientImpl implements Query {
  ...
  StoredGame(request: QueryGetStoredGameRequest): Promise<QueryGetStoredGameResponse> {
    ...
    const promise = this.rpc.request('avalkov.cosmoscheckersgame.cosmoscheckersgame.Query', 'StoredGame', data)
  ...
  StoredGameAll(request: QueryAllStoredGameRequest): Promise<QueryAllStoredGameResponse> {
    ...
    const promise = this.rpc.request('avalkov.cosmoscheckersgame.cosmoscheckersgame.Query', 'StoredGameAll', data)
  ...
  NextGame(request: QueryGetNextGameRequest): Promise<QueryGetNextGameResponse> {
    ...
    const promise = this.rpc.request('avalkov.cosmoscheckersgame.cosmoscheckersgame.Query', 'NextGame', data)
